...
func (r *Runner) caseModelsOpenAI(ctx context.Context, cc *caseContext) error {
	...
	cc.assert("has_deepseek_vision", contains(ids, "deepseek-vision"), strings.Join(ids, ","))
	cc.assert("has_deepseek_vision_reasoner", contains(ids, "deepseek-vision-reasoner"), strings.Join(ids, ","))
	cc.assert("has_deepseek_vision_search", contains(ids, "deepseek-vision-search"), strings.Join(ids, ","))
	return nil
}
